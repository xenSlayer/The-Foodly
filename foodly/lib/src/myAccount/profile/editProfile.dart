...
class _EditProfileState extends State<EditProfile> {
  ...
  void initState() {
    ...
    _phoneNumber.text = widget.eUser.phoneNumber.toString() == "null"? "" :widget.eUser.phoneNumber.toString();
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    validator: (val) {
                      if (val.isEmpty || val.length != 10) return "*This can't be empty or not equal to 10 numbers";
                      return null;
                    },
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(color: Colors.black),
                      hintText: widget.eUser.phoneNumber.toString() == "null" ? "" : widget.eUser.phoneNumber.toString(),
                      filled: true,
                      fillColor: Colors.white,
                    ),
                  ),
